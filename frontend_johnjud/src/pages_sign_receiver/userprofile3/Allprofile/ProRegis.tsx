...
const Apps=(props:any) => {
  ...
  const petPro = obj.map(item=>(<span><PetBlock message = {item.PetName} img={item.PetPicURL} link={`/donator/petprofile/`+item.petid}/></span>))
      ...
      <div className = 'Profile'>
        ...
        <LeftBlock userId ={userId}/>
          ...
          <div className = 'bottomblock'>
            <br></br>
            <h4 className='h4'> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pet Registeration</h4>
