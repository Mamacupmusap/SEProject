          ...
          <Container>
            <div className= "row">
              ...
              <div className= "main"><h6>
                Johnjud เป็นเว็บแอพพลิเคชั่นที่ถูกสร้างขึ้นโดยมีจุดมุ่งหมายให้เป็นศูนย์กลางการหาบ้านให้กับน้องหมา น้องแมว หรือสัตว์ชนิดอื่นๆได้พบกับเจ้าของใหม่และได้มีบ้านที่อบอุ่น<br/>
                <br/><br/>
